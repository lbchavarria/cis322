...
asset_at,*/
*/
INSERT INTO hqinv (SELECT * FROM dcinv)
INSERT INTO hqinv (SELECT * FROM ncinv)
INSERT INTO hqinv (SELECT * FROM MB008inv)
INSERT INTO hqinv (SELECT * FROM spnvinv)
...
/*Lucas*/
/*Below is scratch work but contains basic syntax. Not sure if necessary */
